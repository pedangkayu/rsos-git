      ...
      <div class="row">
        <form action="{{ url('/coa/editledger') }}" method="post" role="form">
          ...
          <div class="col-sm-10">
            ...
            <input type="hidden" name="id_coa_ledger" value="{{ $data->id_coa_ledger }}">
            @if((Session::get('sess')))
            ...
            <div class="form-group">
              ...
              <div>
                <input type="text" value="{{ $data->nm_coa_ledger }}" class="form-control" id="nm_coa" name="nm_coa_ledger" required="required" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div>
                <input type="text" value="{{ $data->no_coa_ledger }}" class="form-control" id="no_coa" name="no_coa_ledger" required="required" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div>
                <select class="form-control" id="parent" name="idparent">
                  ...
                  <option value="{{ $menus->id_coa }}" {{ empty($data) ? '' : $menus->id_coa == $data->grup_coa ? 'selected="selected"' : '' }}>- {{ $menus->nm_coa }}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <label for="title">Opening Balance *</label>
              <div class="row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="balance" id="balance" value="{{ $data->balance }}">
