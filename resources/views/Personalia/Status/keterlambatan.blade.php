...
@endsection
@section('meta')<script src="{{ asset ('/js/tabs_accordian.js') }}" type="text/javascript"></script>
	...
	<div class="col-md-12">
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="{{ url('status_karyawan/keterlambatan') }}">Keterlambatan Pegawai</a></li>
					...
					<div class="row">
						<div class="grid simple">
							<div class="grid-title no-border">
								<h4>Catatan Keterlambatan Pegawai</h4>
								<div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
							</div>
							<div class="grid-body no-border"> <br>
								<div class="row">
									<form action="{{ url('status_karyawan/keterlambatan') }}" method="post">
										...
										<div class="col-md-8 col-sm-8 col-xs-8">
											...
											<div class="form-group">
												...
												<div class="control">
													<div class="input-append success date col-md-10 col-lg-6 no-padding">
														<input type="text" name="datetime_out" class="form-control" data-provide="datepicker">
														<span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span> 
													</div>
												</div>
											</div>
