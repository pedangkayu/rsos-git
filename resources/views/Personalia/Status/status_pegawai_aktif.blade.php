	...
	<div class="col-md-12">
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="{{ url('status_karyawan/pegawaitidakaktif') }}">Pegawai Tidak Aktif</a></li>
			</ul>
					...
					<div class="row">
						<div class="grid simple">
							<div class="grid-title no-border">
								<h4>Update Status Karyawan Tidak Aktif menjadi Aktif</h4>
											...
											<div class="form-group">
												...
												<div class="controls">
													<select class="form-control" name="id_karyawan" id="id_karyawan">
														...
														@foreach($aktifasi_karyawan as $datas)
