	...
	<div class="col-md-12">
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="{{ url('status_karyawan/meninggalkan') }}">Meninggalkan Pekerjaan</a></li>
					...
					<div class="row">
						<div class="grid simple">
							<div class="grid-title no-border">
								<h4>Catatan Pegawai Pulang Lebih Awal / Meninggalkan Pekerjaan</h4>
											...
											<div class="form-group">
												...
												<div class="controls">
													<div class="input-append bootstrap-timepicker-component">
														<input type="text" class="timepicker-default span12" name="time" id="time">
												...
												<div class="form-group">
													...
													<div class="control">
														<div class="input-append success date col-md-10 col-lg-6 no-padding">
															<input type="text" name="datetime_out" class="form-control" data-provide="datepicker" value="{{ date('m/d/Y') }}">
															<span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span> 
														</div>
													</div>
												</div>
