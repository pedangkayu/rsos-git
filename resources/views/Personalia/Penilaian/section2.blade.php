...
@endsection
@section('content')
<form action="{{ url('penilaian/section3') }}" method="post">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
	<div class="">
		<ul class="wizard-steps">
			...
			<li data-target="#step2" class="active"> <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">Prestasi Kerja</span> </a> </li>
