...
@section('content')
	<form method="post" action="{{ url('/po/edit') }}" id="simpan">
									...
									<tr title="{{ $item->nm_barang }}">
										<td>
											...
											<span class="text-muted list-harga last-harga-{{ $item->id_barang }}">
												<button class="btn btn-primary btn-mini btn-lg" data-toggle="modal" onclick="logharga({{ $po->id_vendor }}, {{ $item->id_barang }},1);" data-target="#myModal">Log Harga</button>
											</span>
				...
				<div class="grid simple">
					...
					<div class="grid-body no-border">
						...
						<div class="form-group">
							...
							<div class="input-group transparent">
							 	<span class="input-group-addon"> </span>
							  	<input data-number="true" type="number" name="gdiskon" id="gdiskon" class="form-control text-right" title="Diskon keseluruhan item" value="{{ (INT) $po->diskon }}">
							  	<span class="input-group-addon">
									% &nbsp;&nbsp;
							  	</span>
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group transparent">
							 	<span class="input-group-addon"></span>
							  	<input data-number="true" type="number" name="gppn" id="gppn" class="form-control text-right" title="PPN keseluruhan item" value="{{ $po->ppn }}" pattern="^\d*\.?\d*$" step="0.01">
							  	<span class="input-group-addon">
									% &nbsp;&nbsp;
							  	</span>
							</div>
						...
						<!-- <div class="form-group">
							...
							<div class="input-group transparent">
							 	<span class="input-group-addon"></span>
							  	<input data-number="true" type="number" name="gpph" id="gpph" class="form-control text-right" title="PPH keseluruhan item" value="{{ $po->pph }}" pattern="^\d*\.?\d*$" step="0.01">
							  	<span class="input-group-addon">
									% &nbsp;&nbsp;
							  	</span>
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group transparent">
							 	<span class="input-group-addon">
							  	...
							  	<input type="number" name="adjustment" id="adjustment" class="form-control text-right" title="Penyesuaian" value="{{ $po->adjustment }}" pattern="^\d*\.?\d*$" step="0.01">
							</div>
						</div>
				...
				<div class="grid simple">
					...
					<div class="grid-body no-border">
						...
						<div class="form-group">
							...
							<textarea name="ket" class="form-control">{{ $po->keterangan }}</textarea>
						</div>

						<div class="form-group">
							<label for="deadline">Deadline</label>
							<div class="input-group">
						      <input type="text" class="form-control tgl" name="deadline" id="deadline" readonly="readonly" value="{{ $po->deadline }}">
						    </div><!-- /input-group -->
						</div>
						...
						<div class="form-group btn-proses">
							...
							@endif
							<a class="btn btn-block btn-primary" href="{{ url('/po') }}">Kembali</a>
						</div>
