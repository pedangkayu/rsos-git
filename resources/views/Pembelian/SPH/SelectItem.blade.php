...
@section('meta')
	<script type="text/javascript" src="{{ asset('/js/modpembelian/prq/master.js') }}"></script>
		...
		<div class="col-sm-3">
			...
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					...
					<br />
					<div class="form-group btn-sph hide">
						<a href="{{ url('/sph/create') }}" class="btn btn-block btn-primary">Buat SPH</a>
					</div>

					<a href="{{ url('/sph') }}" class="btn btn-primary btn-block">Kembali</a>
				</div>
			</div>
