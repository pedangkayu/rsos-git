...
<div class="col-md-12">
	<div class="grid simple">
		...
		<div class="grid-body no-border">
			<form action="{{ url('recruitment\update') }}" method="post">
				...
				<div class="row column-seperation">
					<div class="col-md-8 col-sm-8 col-xs-8">
						<div class="form-group">
							...
							<div class="control">
								<input type="text" required name="posisi" value="{{ $data->posisi }}" class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="control">
								<div class="input-append success date col-md-10 col-lg-6 no-padding">
									<input type="text" name="date_open" value="{{ $data->date_open }}" class="form-control" data-provide="datepicker" value="{{date('m/d/Y')}}">
						...
						<div class="form-group">
							...
							<div class="control">
								<div class="input-append success date col-md-10 col-lg-6 no-padding">
									<input type="text" name="date_close" class="form-control" value="{{ $data->date_close }}" data-provide="datepicker" value="{{date('m/d/Y')}}">
									<span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span> 
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="control">
								<input type="text"  class="form-control" maxlength="12" name="syarat" value="{{ $data->syarat }}">
							</div>
						</div>
						<div class="form-group">
							<div class="form-label">Estimasi Gaji</div>
							<div class="control">
								<input type="text" class="form-control" name="estimasi_gaji" value="{{ $data->estimasi_gaji }}">
							</div>
						</div>
						<div class="form-group">
							<div class="form-label">Job Desk</div>
							<div class="control">
								<textarea id="some-textarea" name="job_desk" style="width:100%; height:300px;">{{ $data->jobdesk }}</textarea>
							</div>
						</div>
						<div class="form-group">
