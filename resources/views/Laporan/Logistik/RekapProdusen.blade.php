...
@section('meta')
	<script type="text/javascript" src="{{ asset('/js/Laporan/Logistik/lprodusen.js') }}"></script>
...
@section('title')
Rekap Belanja Produsen (Overall)
@endsection

@section('content')

	<form method="get" action="{{ url('/reportlogistik/printprodusen') }}" target="_blank">
		<div class="row">
			<!-- left -->
			<div class="col-sm-7">
