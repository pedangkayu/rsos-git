...
@section('meta')
	<script type="text/javascript" src="{{ asset('/js/Laporan/Logistik/ldistributor.js') }}"></script>
...
@section('title')
Rekap Belanja Distributor(Overall)
@endsection

@section('content')

	<form method="get" action="{{ url('/reportlogistik/printdistributor') }}" target="_blank">
		<div class="row">
			<!-- left -->
			<div class="col-sm-7">
