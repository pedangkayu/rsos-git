					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="row">
								<div class="col-sm-6">
									<address>
										<strong>Stok Awal Item</strong>
										<p>{{ number_format($barang->stok_awal,0,',','.') }} {{ $barang->nm_satuan }}</p>
										<strong>Stok Awal / Periode</strong>
										<p>{{ number_format($lastsisa,0,',','.') }} {{ $barang->nm_satuan }}</p>
									</address>
								</div>
								<div class="col-sm-6">
									<address>
										...
										Satuan : <strong> {{ $barang->nm_satuan }}</strong>
									</address>
								</div>
							</div>
					...
					<div class="text-right">
						...
						<div class="btn-group" style="width:100%;">
						  	...
						  	<ul class="dropdown-menu" role="menu">
						    	<li>
						    		<a target="_blank" href="{{ url('/reportlogistik/printks?' . $param) }}">Print</a>
						    	</li>
						    	<li>
						    		<a target="_blank" href="{{url('/reportlogistik/printpdf?'. $param)}}">PDF</a>
						    	</li>
						    	<li>
						    		<a target="_blank" href="{{url('/reportlogistik/printexcel?'. $param)}}">Excel</a>
						    	</li>
						  	</ul>
						</div>
