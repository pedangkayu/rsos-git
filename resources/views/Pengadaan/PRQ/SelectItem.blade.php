	...
	<div class="row">
									...
									<td colspan="4">
										<div class="row">
											<div class="col-xs-12">
												...
												<input type="hidden" name="jenis" value="{{ $tipe }}">
											</div>
										</div>
									</td>
								</tr>
		...
		<div class="col-sm-3">
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					...
					<div class="form-group">
						<a href="{{ url('/prq') }}" class="btn btn-primary btn-block">Kembali</a>
					</div>
				</div>
			</div>
			...
			<div class="grid simple hide cart">
				...
				<div class="grid-body no-border">
					<a href="{{ url('/prq/create/' . $tipe) }}" class="btn btn-block btn-primary"><i class="fa fa-shopping-cart"></i> Buat Baru</a>
					<a data-toggle="tooltip" data-placement="bottom" title="Menambahkan item yang sudah terpilih ke dalam pengajuan yang sudah dibuat sebelumnya" href="{{ url('/prq/additemprq/' . $tipe) }}" class="btn btn-block btn-primary"><i class="fa fa-plus"></i> Penambahan</a>
				</div>
			</div>
