...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/refrensi/satuan.js') }}"></script>
<style type="text/css">
	...
	<div class="col-sm-8">
		<div class="grid simple">
			<div class="grid-title no-border">
				<h4>{{ $items->total() }} Satuan <span class="semi-bold">ditemukan</span></h4>
				<div class="tools">
			...
			<div class="grid-body no-border">
				<table class="table table-striped table-flip-scroll cf">
					<thead>
						<tr>
							<th>No</th>
							<th><a href="javascript:;">Nama Satuan</a></th>
							<th><a href="javascript:;">Satuan</a></th>
					...
					<tbody class="contents-items">
						...
						<tr class="item_{{ $item->id_satuan }} items">
							<td>{{ $no }}</td>
							<td>
								{{ $item->nm_satuan }}
								<div style="display:none;" class="tbl-opsi">
									<small>[
										...
										<a href="{{ url('satuan/update/'.$item->id_satuan) }}">Edit</a> 
										@endif
										]</small>
									</div>
								</td>
								...
								<td class="text-right">
									...
									@if(Auth::user()->permission > 2)
									<button type="button" class="close hapusSatuan" data-id="{{ $item->id_satuan }}"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
									@endif
									@else
		...
		<div class="col-sm-4">
			<div class="grid simple">
				<div class="grid-title no-border">
					<h4>Tambah<span class="semi-bold"> Satuan</span></h4>
					<div class="tools">
						<a href="javascript:;" class="collapse"></a> 
					</div>
				</div>
			...
			<div class="grid simple">
				<div class="grid-title no-border">
					<h4>Cari <span class="semi-bold">Satuan</span></h4>
					<div class="tools">
						<a href="javascript:;" class="collapse"></a> 
					</div>
				</div>
					...
					<p>
						<div class="form-group">
							<div class="input-group transparent">
								...
								<input type="text" class="form-control" placeholder="Cari Satuan..." name="src">
							</div>
						</div>
